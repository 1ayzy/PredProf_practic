...
def date_render(date):
    ...
    print(date_info)
    return render_template("date.html", date_info=date_info, windows = [[[True, 1], [True, 2], [False, 1], [True, 1], [True, 1]]], date=date, numbers='1, 2' , count_numbers=2, rooms_per_floor=1, windows_per_floor=6)
